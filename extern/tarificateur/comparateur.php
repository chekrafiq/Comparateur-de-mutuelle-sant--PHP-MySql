...
if (isset($_POST['REGIME']))
{
	$clt=new Client($_POST['NOM'],$_POST['PRENOM']
							...
							,$_POST['REGIME']
							,substr($_POST['CP'],0,2),$_POST['EMAIL'],$_POST['telephone']);
...
.classh1 {
	...
	margin-top: 15px;
	padding-left: 15px;
	background-image: url('images/upf.jpg');
...
#Contenair div.left div#box div.middle {
	height: auto;
	width: auto;
	background-image: url('images/middle-boxfilter.jpg');
	padding-top: 10px;
...
#Contenair div.left div#box div.bottom {
	height: 7px;
	background-image: url('images/bottom-box-filter.jpg');
}
...
<div id="Contenair">
	...
	<h1 class="classh1" >Devis Comparatif Personnalis&eacute; </h1>
    ...
    do {
		...
		$letarif=($tarif+$tarifConj+$tarifEnf);
		...
		//NOUVEAU TARIFS : ajouter 3.5% au tarif
   ...
   ?>
		<div>
			...
			<h3><a href="#default">
			<img alt="les tarifs" src="img/<?php echo $row_rsTarifs['ncomp']; ?>.png" /></a></h3>
			<h6 class="doth">.........................</h6>
			<h4>Delai D&apos;attente :</h4>
			...
			$lien='Tableau/swisslife_ma_formule.html';
			else if ( $row_rsTarifs['ngamme']==7 )
			$lien='Tableau/swisslife_astucieuses.html';
			elseif ( $row_rsTarifs['ngamme']==4 )
			$lien='Tableau/amis_santhia.html';
			elseif ($row_rsTarifs['ngamme']==5 )
			$lien='Tableau/amis_senior.html';
			elseif ( $row_rsTarifs['ngamme']==3 )
			$lien='Tableau/April-famille.html';
			elseif ( $row_rsTarifs['ngamme']==6 )
			$lien='Tableau/smam_securite_sante.html';
			else
			$lien='#';
			?>
			...
			<!--######################## SOUSCRIPTION ################################"-->
			<h5>
			<input class="autre" name="pdf" type="button" value="Souscrire en ligne" />
			</h5>
			<!--######################## FIN SOUSCRIPTION ################################"-->
			<!--######################## FIN SOUSCRIPTION ################################"-->
			<h5>
			<a class="autre" href="mail.php?f=<?php echo $row_rsTarifs['NOMFRML'];?>&c=<?php echo $row_rsTarifs['NOMCMP'];?>&t=<?php echo round($letarif,2);?>&tel=<?php echo $telephone ?>&em=<?php echo $email?>">Recevoir le Devis</a>
			</h5>
			<!--######################## CONTACTER NOUS ################################"-->
			<!--######################## CONTACTER NOUS ################################"-->
			<h5>
			<input class="autre" name="pdf" type="button" value="Contacter nous"  />
			</h5>
			<!--######################## CONTACTER NOUS ################################"-->
			<!--######################## CONTACTER NOUS ################################"-->
