...
print("</table><br><br>");
show_hr();
print("<form action=$PHP_SELF method=post><input type=hidden name=p_propertyaction value=add><input type=submit value='créer un nouveau type de page' class=button></form>");
