...
$l_sql = "SELECT count(remotereferer) as n, remotereferer as r FROM $table_visitor WHERE cookie = '1' AND remotereferer != '' AND date_format(firstvis,'%Y') = '$p_year' GROUP BY remotereferer ORDER BY n DESC LIMIT 0,100";
$c_db->query($l_sql);
