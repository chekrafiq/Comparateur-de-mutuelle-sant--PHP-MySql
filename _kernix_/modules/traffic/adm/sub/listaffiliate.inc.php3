...
$l_sql = "SELECT page, COUNT(*) as tmp FROM $table_log WHERE page NOT LIKE '' AND date LIKE '$p_year-$p_nummonth-%' AND  bringer = '1' GROUP BY page ORDER BY tmp DESC LIMIT 0,3";
$c_db->query($l_sql);
