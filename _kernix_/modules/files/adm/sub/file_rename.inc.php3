...
rename("/home/web/$g_accountname/www/upload/$p_rep/$p_oldfile_name","/home/web/$g_accountname/www/upload/$p_rep/$p_userfile_name");
show_response("le fichier <br>< <i>$p_oldfile_name</i> > <br>a bien été renommé en <br>< <i>$p_userfile_name</i> >.");
print("<br>");
