...
$l_sql = "INSERT INTO $table_post (title,content,idboard,level,validflag,adminflag,nickname,email,url,idparent,idvisitor,lastreplydate,date) VALUES ('$p_title','$p_content','$p_idboard','$p_level','$p_validflag','$p_adminflag','$p_nickname','$p_email','$p_url','$p_idparent','$g_idvisitor','$l_date','$l_date')";
$c_db->query($l_sql);
