...
?>
 ...
 <tr>
  ...
  <input type="checkbox" name="p_pref" value="1" <?=($p_pref==1) ? "checked" : ""?>> <em class="contenu">je suis intéressé(e) par des offres préférentielles de nos partenaires</em><br /> <br />
