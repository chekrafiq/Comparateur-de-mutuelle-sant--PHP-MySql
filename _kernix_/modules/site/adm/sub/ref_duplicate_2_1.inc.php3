...
//##########################################
// couper coller des sous références uniquement
//##########################################

$l_sql = "SELECT nodekey FROM $table_ref where idref = '$p_idref_source'";
//  print("->$l_sql<br>");
$c_db->query($l_sql);
$l_refsource = $c_db->object_result();

$l_sql = "SELECT nodekey FROM $table_ref where idref = '$p_idref'";
//  print("->$l_sql<br>");
$c_db->query($l_sql);
