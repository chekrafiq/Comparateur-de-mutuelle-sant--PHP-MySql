<form method="POST" action="<?php print($PHP_SELF); ?>">
 <input type="hidden" name="p_msgaction" value="store">
 <input type="hidden" name="p_msgflag" value="create">

 <table align="center" width="85%"> 
  <tr>
   <td align="left" class="color1" height="20" colspan="2">
    :: Creer un nouveau msg
   </td> 
  </tr>
  <tr>
   <td width="30%" align="right" class="color2">code &nbsp;</td> 
   <td class="color3">
  ...
  <tr>
   ...
   <td class="color3">
    <textarea name="p_title" cols="50" rows="4"></textarea>
   </td>
  </tr>
  <tr>
