...
<title>Suisse Avenir : Conditions </title>
...
<div class="container_10 wrapper m_t_10">
	<div id="content" class="grid_2">
		<div id="menu_for_statique">
			<img alt="Suisse Avenir" src="../../../../images/avenir.jpg" />
			<ul class="color_ver">
				<li><a title="Garanties" href="../garantie/garantie-suisse-avenir.php">Garanties</a></li>
				<li><a title="Montants" href="../garantie/montants-suisse-avenir.php">Montants</a></li>
				<li><a title="Conditions" href="suisse-avenir-condition.php">Conditions</a></li>
	...
	<div id="content" class="grid_5">
		<h1>Siwsslife , Swiss avenir</h1>
				<h2>Condition de votre Complémentaire santé.</h2><p>Les conditions de souscription d'un contrat Suisse Avenir sont très simples. Vous trouverez ci-après un rappel des principales règles de souscription :
</p>
		<h3>- Age limite de souscription : </h3><ul style="color:black"><li>- 80 
			ans</li>
			</ul>
			<h3>- Durée du contrat :</h3>
			<ul style="color:black"><li>- 10 ans</li>
			</ul><h3>- Participations aux bénéfices :</h3><ul style="color:black"><li>- Attribuée chaque 31 décembre.</li>
			</ul><div class="message_box_wrap notice">Pour plus d'informations concernant ce produit, merci de nous adresse votre demande par mail à l'adresse suivante : 
