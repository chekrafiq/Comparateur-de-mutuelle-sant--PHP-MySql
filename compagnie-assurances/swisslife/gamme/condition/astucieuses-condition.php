...
<title>Swiss Santé Les Astucieuses - condition</title>
...
<div class="container_10 wrapper m_t_10">
	<div  class="grid_2">
		<div id="menu_for_statique">
			...
			<ul class="color_bl">
				<li><a href="../garantie/garantie-astucieuses.php" title="Garanties astucieuse">Garanties</a></li>
				<li><a href="../../../../devis-mutuelle-etape1.php" title="Tarifs">Tarifs </a></li>
				<li><a href="astucieuses-condition.php" title="Conditions astucieuses">Conditions
</a></li>
				<li><a href="../../../../souscription-enligne.php" title="Souscrire astucieuse ">Souscrire</a></li>
				<li class="retour_bl"><a href="#">Retour</a></li>
			</ul>
		</div>
		</div>
	<div id="content" class="grid_5">
		<h1>Swiss Santé Les Astucieuses </h1>
		<h2>Conditions de votre Complémentaire santé.</h2>
		<h3>- Age de souscription :</h3>
		<p>• Jusqu’à 65 ans (inclus)</p>

		<h3>- Délais d’attente :</h3>
		<p>• Aucun délai d’attente</p>
		<h3>- Modalités de paiement :</h3>
		<p>• Prélèvement automatique mensuel sans frais </p>
