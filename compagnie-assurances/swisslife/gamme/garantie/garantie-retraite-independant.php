...
<title>Retraite Indépendant : Garantie </title>
...
<div class="container_10 wrapper m_t_10">
	<div  class="grid_2">
		<div id="menu_for_statique">
			...
			<ul class="color_ver">
				<li><a title="Garanties" href="garantie-retraite-independant.php">Garanties</a></li>
				<li><a title="Montants" href="montants-retraite-independant.php">Montants</a></li>
				<li><a title="Conditions" href="../condition/retraite-independant-condition.php">Conditions</a></li>
	...
	<div id="content" class="grid_5">
		<h1>Retraite Indépendant</h1>
				<h2>Garantie de votre Complémentaire santé.</h2>
				<p>Garantie Retraite Indépendants est un contrat collectif d'assurance vie à adhésion facultative, garantissant la constitution d'une retraite par capitalisation. Il est souscrit dans le cadre de la Loi Madelin.
</p>
<p>En cas de vie de l'adhérent au terme du contrat : versement d'une rente à vie exclusivement, calculée à partir du Compte de Retraite et dont le taux de conversion est défini à l'adhésion.
</p>
<p>Lors du départ en retraite, 4 formules de rentes à vie seront proposées : non–réversible, réversible à 50 ou 100 % ou non–réversible avec annuités certaines.
</p>
<p>En cas de décès de l'adhérent avant son 65° anniversaire, ou avant sa retraite professionnelle : versement au(x) bénéficiaire(s) de la rente constituée par le capital au contrat.
</p>		<div class="message_box_wrap notice">Pour plus d'informations concernant ce produit, merci de nous adresse votre demande par mail à l'adresse suivante : 
