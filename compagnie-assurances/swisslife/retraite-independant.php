...
<title>Retraite Indépendant, SwissLife assurance retraite indépendant  </title>
...
<div class="container_10 wrapper m_t_10">
	<div  class="grid_2">
		<div id="menu_for_statique">
			...
			<ul class="color_ver">
				<li><a title="Garanties" href="gamme/garantie/garantie-retraite-independant.php">Garanties</a></li>
				<li><a title="Montants" href="gamme/garantie/montants-retraite-independant.php">Montants</a></li>
				<li><a title="Conditions" href="gamme/condition/retraite-independant-condition.php">Conditions</a></li>
	...
	<h1><a href="retraite-independant.php" title="Retraite Indépendant">Retraite Indépendant :</a></h1>
	<h2>Constituez votre retraite tout en défiscalisant vos cotisations…</h2>
		<p>Maintenir son pouvoir d’achat à la retraite est un sujet de préoccupation pour les professions libérales , les commerçants et les artisans.</p>
		<p>Pour pallier la fragilité des régimes obligatoires et leurs conditions moins avantageuses que celles réservées aux salariés, la société SwissLife vous propose 
		<strong>Garantie Retraite Indépendants</strong>, un contrat de retraite complémentaire par capitalisation, adapté à votre activité professionnelle</p>
		<h3>Vos atouts gagnants :</h3>
		<ul style="color:black"><li>Une rente à vie garantie dès l’adhésion.</li><li>Des cotisations déductibles.
			</li>
			<li>Un pouvoir d’achat protégé.</li>
			<li>Une sécurité financière pour vos proches.</li>
			<li>De hautes performance assurées&nbsp;: 5% nets distribuées en 2004.</li></ul>
