...
<title>Suisse Obsèques : Pour profiter de la vie en toute quiétude</title>
...
<div class="container_10 wrapper m_t_10">
	<div  class="grid_2">
		<div id="menu_for_statique">
			<img alt="Suisse Obsèques" src="../../images/liberte.jpg" />
			<ul class="color_ver">
				<li><a title="Garanties" href="gamme/garantie/garantie-suisse-obseques.php">Garanties</a></li>
				<li><a title="Tarifs" href="gamme/garantie/tarifs-suisse-obseques.php">Tarifs</a></li>
				<li><a title="Conditions" href="gamme/condition/suisse-obseques-condition.php">Conditions</a></li>
	...
	<h1><a href="suisse-obseques.php" title="Suisse Obsèques">Suisse Obsèques :</a></h1>
	<h2>Pour profiter de la vie en toute quiétude, avez-vous pensé à tout ?</h2>
		<p>Comme beaucoup de personnes, vous redoutez d’ajouter au chagrin de vos proches une charge financière lourde et imprévue, et des tracas bien pénibles.</p>
		<p>Avec <strong>Suisse Obsèques</strong>, vos proches ne seront plus seuls pour affronter ces problèmes.</p>
		<h3>Vos atouts gagnants :</h3>
		<ul style="color:black"><li>Pas de questionnaire de santé, pas d’examen médical.</li><li>
			Votre cotisation n’augmentera jamais.</li>
			<li>Vous désignez en toute liberté le ou les bénéficiaire(s) de votre contrat.</li>
			<li>Le capital est transmis au bénéficiaire choisi dans les<strong> 48 heures</strong>.</li>
			<li>Une <strong style="color:blue">garantie assistance</strong> particulièrement <strong style="color:blue">étendue</strong> et 
			<strong style="color:blue">rapide</strong>.</li>
			</ul>
