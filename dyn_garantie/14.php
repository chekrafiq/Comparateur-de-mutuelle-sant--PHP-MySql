...
<title>SMAM ,New Equilibre sante Plus 65 Ans</title>
...
<div class="container_10 wrapper m_t_10">
   ...
   ?>
		<!-- box tarif 1 -->
	<div class="boxtarif boxtarif<?php echo 4 ;?>"  >
...
$i++;
	...
	<table style="width: 100%">
		...
		<tr>
			<td class="auto-style5" style="width:57,09% ">Maladie, Chirurgie<br />
			<strong><em>après 6 mois</em></strong></td>
...
animaux domestiques, vous faire bénéficier d’une aide à domicile, prendre en charge la location d’un téléviseur à l’hôpital...</p>
		...
		<tr>
			<td class="auto-style5" style="width:57,09% "><strong>Dépistage et 
			Prévention</strong> (actes non remboursés par le Régime Obligatoire)<br />
...
rechercher une infirmière ou tout autre intervenant paramédical, et organiser la livraison à votre domicile des médicaments indispensables à votre traitement.</p>
	...
	<p>* TÉLÉASSISTANCE MÉDICALISÉE : si vous êtes âgé(e) de 75 ans et plus et que vous vous trouvez isolé(e) pendant votre convalescence après une hospitalisation supérieure
...
à votre demande prolonger cette mise à disposition à un tarif préférentiel.</p>
				<table style="width: 100%">
					<caption>VOTRE CONTRAT PREND ÉGALEMENT EN CHARGE</caption>
		<tr>
			<td class="auto-style5" style="width:57,09% "><strong>Individuelle 
			accident (Capital décès par accident)</strong><br />
			(sans limite d’âge)</td>
			<td class="auto-style3" style="width: 57.72%;text-align:left">Adhérent principal 
			<strong>4 
			000 €</strong><br />
			Conjoint (inscrit au contrat) <strong>2 000 €</strong></td>
					</tr>
		<tr>
			<td class="auto-style5" style="width:57,09% ;text-align:left"><strong>Individuelle 
			seniors (Invalidité permanente par accident)</strong><br />
			Les montants maximal garantis ci-contre sont indiqués par assuré et 
			par évènement</td>
			<td class="auto-style3" style="width: 57.72%;text-align:left">Dans le cas d’une 
			Invalidité Permanente par accident supérieure à 50%<br />
			- Capital forfaitaire<strong> 3 000 €</strong><br />
			-
			Aide à la vie quotidienne <strong>500 €</strong></td>
					</tr>
		<tr>
		...
		<tr>
			...
			<td class="auto-style3" style="width: 57.72% ;text-align:left"><strong>Maximum 20 
