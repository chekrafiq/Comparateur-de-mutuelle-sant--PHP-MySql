...
<title>A propos du sinader</title>
...
<div class="container_10 wrapper m_t_10">
	...
	<h1>A propos :</h1>
	<h2>Cette rubrique vous permet de mieux connaitre</h2>
<h3>Swiss Life :</h3> 
	
	
		<p>Avec plus de 3 millions d’assurés en France, SwissLife est un groupe internationale créé en 1857 en Suisse.</p>
		<p>La France représente pour le Groupe le pôle le plus important après la Suisse. Ses 6 pôles spécialisés sont la santé, la vie, la retraite, l’épargne/placements, les services financiers, mais aussi les dommages et l’assistance… </p>
	<h3>La Fiscalité :</h3>
	<ul style="color:black"><li>Loi Madelin :
Destinée aux travailleurs non salariés, elle permet de déduire de leurs revenus imposables les cotisations souscrites au titre de leurs contrats SwissLife.</li>
<li>Assurance-Vie :
Toute personne physique peut en bénéficier (salariés et indépendants).</li>
</ul>
